...
export const CONTENT_SCAN_MESSAGE = "jelluvi/v5/content-scan";
export const CONTENT_CANCEL_SCAN_MESSAGE = "jelluvi/v5/content-cancel-scan";
export const CONTENT_GET_SCAN_CACHE_SUMMARY_MESSAGE = "jelluvi/v5/content-get-scan-cache-summary";
export const CONTENT_GET_CACHED_CONVERSATION_MESSAGE = "jelluvi/v5/content-get-cached-conversation";
