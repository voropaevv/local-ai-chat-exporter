...
const PERPLEXITY_MESSAGE_SELECTORS: readonly VisibleMessageSelector[] = [
  {
    ...
    role: "user",
    selector:
      "[data-testid='query-text'], [data-test-id='query-text'], [data-testid='query-content'], [data-testid='thread-question'], [class~='group/query'], [class~='group/user-bubble'], [aria-label='Search query'] h1, main header h1, main section h1"
  },
  {
    authorLabel: "Perplexity",
    role: "assistant",
    selector:
      "[data-testid='answer'], [data-test-id='answer'], [data-testid='answer-content'], [data-testid='thread-answer'], [class~='group/final-text'], main [id^='markdown-content-'] .prose[data-renderer='lm'], main .prose"
  }
];
