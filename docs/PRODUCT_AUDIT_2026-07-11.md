...
| [AI Chat Exporter](https://chromewebstore.google.com/detail/ai-chat-exporter/dfkonbknfdohjkabbajhghecgjpbmphc)                        | ChatGPT, Gemini and Claude; selection, media, statistics.                         | Wider output set, reproducible archive model, local library and open implementation. | Live multi-provider validation must remain current.                 |
