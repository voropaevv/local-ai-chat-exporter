...
- No optional API permissions are requested; in particular, Jelluvi does not request `tabs`,
...
- The icon source is `assets/brand/jelluvi.png`; light-theme primary actions and focus states use
  accessible deep blue `#005FEF`, while cyan remains a bundled brand accent.
