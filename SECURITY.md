# Jelluvi Security Policy

## Security Model

Jelluvi is designed to be local-first:
...
`https://github.com/voropaevv/local-ai-chat-exporter/security/advisories/new`
